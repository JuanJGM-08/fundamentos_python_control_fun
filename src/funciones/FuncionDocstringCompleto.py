...
# este código define una función `calcular_precio_final` que calcula el precio final de un producto aplicando un descuento y un impuesto. La función incluye una docstring detallada que describe su propósito, los argumentos que recibe, lo que devuelve, las excepciones que puede generar y ejemplos de uso. Al llamar a esta función con diferentes valores de precio base, descuento e impuesto, se puede obtener el precio final correspondiente. Este ejemplo muestra cómo crear una función para realizar cálculos financieros y cómo documentarla adecuadamente para mejorar su claridad y usabilidad.